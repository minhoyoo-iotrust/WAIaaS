...
v1.5.5(Jupiter)와 v1.5.6(0x)이 각각 Solana/EVM 내 스왑을 지원하지만, **체인 간 자산 이동**은 불가능하다. WAIaaS는 멀티체인 월렛(v1.4.6)을 지원하므로, 같은 Owner의 Solana 월렛과 EVM 월렛 간 자산을 이동하거나 체인을 넘어 스왑하는 기능이 필요하다.
...
| v1.5.5/v1.5.6 (Jupiter/0x) | 내장 프로바이더 패턴, packages/actions/ 구조 재사용 |
