...
*최종 업데이트: 2026-02-14. Admin Web UI 재사용 아키텍처로 변경 — React 18 재구현 대신 기존 Preact Admin Web UI를 WebView에서 로드. Desktop 전용 기능(Sidecar, 트레이, Wizard, WalletConnect)만 추가. 설계 문서 39 변경은 v1.6.1에서 수행.*
