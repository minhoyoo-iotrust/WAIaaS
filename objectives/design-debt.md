...
- 처리 완료: 4건
  - DD-01: v1.1 구현 후 처리 완료 (doc 37 §6.12 추가)
  - DD-02: v1.1 구현 후 처리 완료 (doc 37 §6.13 추가)
  - DD-03: v1.1 구현 후 처리 완료 (doc 37 §4.2, §8.18.2 수정)
  - DD-04: v1.4에서 처리 완료 (INSUFFICIENT_FOR_FEE TX 도메인 정의)
- 미해결: 0건
- v2.1 이연: 0건
- 잠재 부채 검색: v1.1~v1.8 마일스톤 objective에서 "부채", "이연", "미구현", "TODO" 키워드 검색 수행. 발견된 "미구현" 참조는 모두 해당 시점에서 미구현이었으나 후속 마일스톤에서 구현 완료된 항목. "이연" 참조는 전부 doc 39(Tauri Desktop) v2.6.1 이연으로 별도 추적 중.
