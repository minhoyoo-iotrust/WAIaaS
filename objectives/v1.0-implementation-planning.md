...
- [ ] v0.7 구현 장애 요소 25건 해소 (설계 문서 수정)
- [ ] v0.8 Owner 선택적 등록 설계 완료
- [ ] v0.9 MCP 세션 관리 자동화 설계 완료
...
| 27 | chain-adapter-interface | IChainAdapter 19 메서드, AdapterRegistry |
