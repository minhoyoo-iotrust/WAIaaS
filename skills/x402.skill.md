...
Before using x402 auto-payment, ensure the admin has completed:

1. **x402 enabled** in config.toml or Admin Settings
2. **X402_ALLOWED_DOMAINS policy** for the wallet (default-deny) -- see docs/admin-manual/policy-management.md
3. **SPENDING_LIMIT policy** (optional): Controls per-period spending
