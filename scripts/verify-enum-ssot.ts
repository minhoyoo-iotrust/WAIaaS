...
const ENUMS: EnumDef[] = [
  ...
  { name: 'TransactionType', array: TRANSACTION_TYPES, zodOptions: TransactionTypeEnum.options, expectedCount: 9 },
  { name: 'PolicyType', array: POLICY_TYPES, zodOptions: PolicyTypeEnum.options, expectedCount: 21 },
  ...
  { name: 'NotificationEventType', array: NOTIFICATION_EVENT_TYPES, zodOptions: NotificationEventTypeEnum.options, expectedCount: 66 },
  { name: 'NotificationLogStatus', array: NOTIFICATION_LOG_STATUSES, zodOptions: NotificationLogStatusEnum.options, expectedCount: 2 },
  { name: 'AuditAction', array: AUDIT_ACTIONS, zodOptions: AuditActionEnum.options, expectedCount: 26 },
