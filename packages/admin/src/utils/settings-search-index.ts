...
export const SETTINGS_SEARCH_INDEX: SearchIndexEntry[] = [
  ...
  { id: 'system..signing_sdk_notifications', label: 'Notifications Enabled', description: 'Push event notifications to wallet apps', page: '/system', tab: '', fieldName: 'signing_sdk.notifications_enabled', keywords: ['signing', 'sdk', 'notification', 'wallet', 'push'] },
];
