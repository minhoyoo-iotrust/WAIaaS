...
export const SETTINGS_SEARCH_INDEX: SearchIndexEntry[] = [
  ...
  { id: 'settings..signing_sdk_preferred_channel', label: 'Preferred Channel', description: 'Preferred signing channel for SDK requests', page: '/settings', tab: '', fieldName: 'signing_sdk.preferred_channel', keywords: ['signing', 'sdk', 'channel', 'ntfy', 'telegram'] },
