...
export const messages: Messages = {
  ...
  notifications: {
    ...
    POLICY_VIOLATION: { title: '정책 위반', body: '{walletName} 정책 위반: {reason}. 정책: {policyType}. 관리: {adminLink}' },
    WALLET_SUSPENDED: { title: '지갑 정지', body: '{walletName}이(가) 정지되었습니다: {reason}' },
    ...
    AUTO_STOP_TRIGGERED: { title: '자동 정지 발동', body: '{walletName} 자동 정지: {reason}. 규칙: {rule}' },
    SESSION_EXPIRING_SOON: { title: '세션 만료 임박', body: '{walletName}의 세션 {sessionId}이 {minutes}분 후 만료됩니다' },
    SESSION_EXPIRED: { title: '세션 만료', body: '{walletName}의 세션 {sessionId}이 만료되었습니다' },
    SESSION_CREATED: { title: '세션 생성', body: '{walletName}의 새 세션이 생성되었습니다' },
    SESSION_WALLET_ADDED: { title: '세션에 지갑 추가', body: '{walletName}이(가) 세션 {sessionId}에 추가되었습니다' },
    SESSION_WALLET_REMOVED: { title: '세션에서 지갑 제거', body: '{walletName}이(가) 세션 {sessionId}에서 제거되었습니다' },
    OWNER_SET: { title: 'Owner 등록', body: '{walletName}에 Owner가 등록되었습니다: {ownerAddress}' },
    OWNER_REMOVED: { title: 'Owner 제거', body: '{walletName}에서 Owner가 제거되었습니다' },
    OWNER_VERIFIED: { title: 'Owner 인증', body: '{walletName}의 Owner가 인증되었습니다' },
    DAILY_SUMMARY: { title: '일일 요약', body: '지갑: {walletCount}개, 거래: {txCount}건, 세션: {sessionCount}개' },
    CUMULATIVE_LIMIT_WARNING: { title: '누적 지출 경고', body: '{walletName}의 {type} 누적 지출이 한도의 {ratio}%에 도달했습니다 (${spent} / ${limit}) {display_amount}' },
    LOW_BALANCE: { title: '잔액 부족 알림', body: '{walletName} 잔액 부족: {balance} {currency}. 임계값: {threshold} {currency}. 자금을 충전해주세요.' },
  ...
  telegram: {
    ...
    bot_cancel_success: '거래가 취소되었습니다\\.',
