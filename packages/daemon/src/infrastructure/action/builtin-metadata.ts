...
export const BUILTIN_PROVIDER_METADATA: ReadonlyArray<{
  ...
  { name: 'dcent_swap', displayName: "D'CENT Swap", description: "D'CENT Swap Aggregator supporting multi-chain DEX swaps including cross-chain swaps", version: '1.0.0', chains: ['ethereum', 'solana'], mcpExpose: true, requiresApiKey: false, enabledKey: 'dcent_swap', category: 'Swap' },
