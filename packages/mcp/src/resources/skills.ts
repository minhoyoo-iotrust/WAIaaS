 ...
 *
 * Exposes 8 skill files (quickstart, wallet, transactions, policies, admin, actions, x402, erc8128)
...
const SKILL_NAMES = ['quickstart', 'wallet', 'transactions', 'policies', 'admin', 'actions', 'x402', 'erc8128'] as const;
