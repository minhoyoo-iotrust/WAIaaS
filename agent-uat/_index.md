...
| ID | Title | Network | Funds | Cost | Risk |
|----|-------|---------|-------|------|------|
| admin-ops-01 | 수신 트랜잭션 감지 | ethereum-sepolia, solana-devnet | Yes | $0.01 | low |
| admin-ops-02 | 잔액 모니터링 | ethereum-sepolia, solana-devnet | Yes | $0.01 | low |

### Advanced
| ID | Title | Network | Funds | Cost | Risk |
|----|-------|---------|-------|------|------|
| advanced-01 | Smart Account UserOp Build/Sign | ethereum-sepolia | Yes | $0.02 | low |
| advanced-02 | x402 HTTP 결제 | ethereum-mainnet, base-mainnet | Yes | $1.00 | medium |
| advanced-03 | 가스 조건부 실행 | ethereum-mainnet | No | $0 | none |
| advanced-04 | 메시지 서명 및 검증 | ethereum-mainnet | No | $0 | none |
| advanced-05 | 트랜잭션 승인 워크플로우 | ethereum-mainnet | Yes | $0.50 | medium |
