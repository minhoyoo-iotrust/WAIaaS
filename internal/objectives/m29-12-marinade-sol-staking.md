# 마일스톤 m29-12: SOL Staking 확장 (Marinade)
...
Marinade는 TVL ~$1.7B으로 Solana 2위 Liquid Staking 프로토콜이다. Jito(m28-04)와 달리 **100+ 밸리데이터 알고리즘 분산 스테이킹**으로 Solana 네트워크 탈중앙화에 기여한다.
...
m28-04의 JitoStakingActionProvider와 동일 패턴으로 구현하므로 추가 프레임워크 구축 불필요.
...
| 의존 대상 | 이유 |
|----------|------|
| m28-04 (Liquid Staking) | 스테이킹 상태 API, Admin 대시보드 스테이킹 섹션 |
