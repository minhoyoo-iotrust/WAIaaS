...
| PerpPositionTracker | 레버리지 포지션 추적. m29-02 통합 positions 테이블(category=PERP) 확장 사용. 추가 필드: market, direction[LONG/SHORT], size, entry_price, leverage, unrealized_pnl, margin, liquidation_price. PositionTracker(m29-02)와 통합 |
...
| 신규/수정 파일 | 18-24개 |
| 테스트 | 10-16개 |
| DB 마이그레이션 | positions 통합 테이블 확장 (m29-00 설계 DEFI-13에 따라 category=PERP 추가) |
