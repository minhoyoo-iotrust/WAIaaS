...
```
waiaas-sign-{walletId}        → 서명 요청 (m26-01, 기존)
waiaas-notify-{walletId}      → 일반 알림 (m26-02, 신규)
```
...
| 의존 대상 | 이유 |
|----------|------|
| m26-01 (Wallet Signing SDK) | @waiaas/wallet-sdk 패키지, ntfy 토픽 구조, owner_approval_method 인프라 |
