...
| 삭제 | `PUT /v1/wallets/:id/default-network` | 기본 네트워크 변경 엔드포인트 |
...
| 대상 | 변경 내용 |
|------|----------|
| `skills/wallet.skill.md` | default network 관련 문구 제거/수정 |
| `skills/transactions.skill.md` | network 명시 필수 안내 추가 |
