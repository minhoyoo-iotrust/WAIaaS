...
- [ ] **Phase 452: Document Structure Rename** - docs/guides/ 를 docs/agent-guides/ 로 이름 변경하고 모든 참조를 업데이트한다
- [ ] **Phase 453: Skills Cleanup + Admin Manual** - masterAuth 콘텐츠를 docs/admin-manual/ 로 추출하고 스킬 파일을 sessionAuth 전용으로 정리한다
