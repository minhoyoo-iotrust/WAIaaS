...
- [x] Phase 300: Session Core API + JWT + Renewal (v29.9) -- completed 2026-03-02
- [x] Phase 301: MCP + CLI + SDK + Admin UI + Skill Files (v29.9) -- completed 2026-03-02

See `.planning/milestones/v29.0-ROADMAP.md` through `v29.9-ROADMAP.md` for full details.
