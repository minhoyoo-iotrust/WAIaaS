...
- [x] **Phase 469: Admin UI Radio Group** (1 plan) - wallet_type 그룹 레이아웃 + 서명 라디오 버튼 + "None" 옵션 (completed 2026-04-02)
...
**Plans:** 1/1 plans complete
Plans:
- [x] 469-01-PLAN.md — wallet_type 그룹 레이아웃 + 서명 라디오 버튼 + "None" 옵션
**Success Criteria** (what must be TRUE):
...
| 469. Admin UI Radio Group | 1/1 | Complete    | 2026-04-02 |
