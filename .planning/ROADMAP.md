...
- [ ] **Phase 380: ResolvedAction 타입 시스템** - ResolvedAction union + ISignerCapability 인터페이스 + SigningSchemeEnum 설계
- [ ] **Phase 381: CredentialVault 인프라** - per-wallet 암호화 자격증명 저장소 + DB 스키마 + REST API 설계
...
|-------|----------------|--------|-----------|
| 380. ResolvedAction 타입 시스템 | 0/2 | Not started | - |
