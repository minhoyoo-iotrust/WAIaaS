...
- [x] **Phase 397: Admin Dashboard UX** - 카테고리 필터, 프로바이더 그룹핑, HF 경고, 지갑 필터 (completed 2026-03-12)
...
Plans:
- [x] 393-01: Lido IPositionProvider 구현 (stETH/wstETH 잔액 조회, wstETH 환산, CAIP-19 assetId, USD 환산)
- [x] 393-02: Jito IPositionProvider 구현 (jitoSOL 잔액 조회, SOL 환산) + duck-type 자동 등록 + 테스트
...
Plans:
- [x] 395-01-PLAN.md — Pendle getPositions() 완성 (PT/YT 잔액 조회, 만기 상태 전환, implied APY) + 테스트
