...
Plans:
- [x] 380-01-PLAN.md — ResolvedAction 3종 Zod 스키마 초안 + 정규화 전략 + 하위 호환 분석
- [x] 380-02-PLAN.md — ISignerCapability 인터페이스 + SigningSchemeEnum(7종) 설계
...
**Plans:** 1 plan
Plans:
- [x] 385-01-PLAN.md — doc-81 통합 설계 문서 작성 + ROADMAP/REQUIREMENTS 업데이트
