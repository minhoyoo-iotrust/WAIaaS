...
Plans:
- [x] 15-01-PLAN.md -- Layer 1 세션 인증 공격 시나리오 12건 + ownerAuth 8건 (SEC-01)
- [x] 15-02-PLAN.md -- Layer 2 정책 우회 9건 + Layer 3 Kill Switch/AutoStop 8건 (SEC-02, SEC-03)
- [x] 15-03-PLAN.md -- 키스토어 보안 + 외부 위협 + 경계값 테스트 + E2E 연쇄 체인 (SEC-04, SEC-05)
