...
- [ ] **Phase 174: 거버넌스 파일** - 퍼블릭 리포 필수 거버넌스 문서 생성
- [ ] **Phase 175: 정리 및 수정** - 잔존 이슈 해소 및 규칙 보완
- [ ] **Phase 176: 문서 구조 통합** - 설계 문서/objectives 디렉토리 재배치 및 경로 갱신
- [ ] **Phase 177: 배포 스모크 테스트** - npm 패키지 스모크 테스트 스크립트 작성 및 CI 통합
...
|-------|----------------|--------|-----------|
| 174. 거버넌스 파일 | 0/1 | Not started | - |
| 175. 정리 및 수정 | 0/2 | Not started | - |
| 176. 문서 구조 통합 | 0/3 | Not started | - |
| 177. 배포 스모크 테스트 | 0/2 | Not started | - |

## Decisions

*(Milestone-level decisions logged here during execution)*
