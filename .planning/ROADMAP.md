...
- [x] **Phase 368: 고급 기능 + 관리자 기능 시나리오** - Smart Account, WalletConnect, x402, 수신 TX, 가스 조건부 + Admin UI 검증 13개 시나리오 (completed 2026-03-10)
- [x] **Phase 369: CI 시나리오 등록 강제** - Provider/시나리오 매핑 검증, 파일 유효성, 인덱스 등록, Admin 라우트 일관성, CI workflow 통합 (completed 2026-03-10)
...
Plans:
- [x] 368-01-PLAN.md -- 고급 기능 시나리오 6개 (Smart Account, WalletConnect, x402, 수신TX, 잔액 모니터링, 가스 조건부)
- [x] 368-02-PLAN.md -- Admin UI 검증 시나리오 전반부 (페이지 접근, 인증, Dashboard, Settings, 정책, 지갑)
- [x] 368-03-PLAN.md -- Admin UI 검증 시나리오 후반부 (NFT, DeFi, 알림, 감사로그, 백업, 토큰, 통계) + _index.md 업데이트
...
| 368. 고급 기능 + 관리자 기능 시나리오 | 3/3 | Complete    | 2026-03-09 |
| 369. CI 시나리오 등록 강제 | 2/2 | Complete    | 2026-03-09 |
