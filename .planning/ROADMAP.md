...
- [ ] **Phase 10: v0.1 잔재 정리** — SUPERSEDED 표기, 변경 매핑 문서 작성
...
Plans:
- [ ] 10-01-PLAN.md — v0.1 → v0.2 변경 매핑 문서 작성 + SUPERSEDED 표기 추가
- [ ] 10-02-PLAN.md — 인터페이스명/에러코드/에스컬레이션 모델 대응표 작성
...
| 10. v0.1 잔재 정리 | v0.3 | 0/2 | Planned | - |
