...
- [x] **INTF-04**: MCP send_token/call_contract 등 도구에 gasCondition 파라미터가 노출된다
- [x] **INTF-05**: TS/Python SDK에 gasCondition 파라미터가 노출된다
- [x] **INTF-06**: transactions.skill.md에 가스 조건부 실행 섹션이 추가된다
- [x] **INTF-07**: ActionProvider resolve 후 gasCondition이 적용된다
...
| INTF-04 | Phase 259 | Complete |
| INTF-05 | Phase 259 | Complete |
| INTF-06 | Phase 259 | Complete |
| INTF-07 | Phase 259 | Complete |
