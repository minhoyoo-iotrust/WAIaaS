...
- [x] **INTG-03**: MCP action_zerox_swap_swap 도구가 자동 노출된다
- [x] **INTG-04**: actions.skill.md에 0x Swap 상세 문서(REST API/MCP/SDK 예시, config, 안전 장치)가 추가된다
...
| INTG-03 | Phase 250 | Complete |
| INTG-04 | Phase 250 | Complete |
