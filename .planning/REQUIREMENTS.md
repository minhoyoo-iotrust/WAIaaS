...
- [ ] **ADMN-01**: USD Tiers 섹션이 최상단에 렌더링됨
- [ ] **ADMN-02**: Token-Specific Limits 섹션에서 네이티브 토큰 한도를 설정할 수 있음
- [ ] **ADMN-03**: "+ Add Token Limit" 버튼으로 CAIP-19 기반 토큰 한도를 추가/삭제할 수 있음
- [ ] **ADMN-04**: 네이티브 심볼이 정책 network에 따라 올바르게 표시됨 (SOL/ETH/POL)
- [ ] **ADMN-05**: Legacy 섹션에 deprecated 안내가 표시됨
- [ ] **ADMN-06**: 신규 정책 생성 시 raw 필드 미입력으로 저장할 수 있음
