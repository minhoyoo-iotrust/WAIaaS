...
## Current Milestone: v31.8 Agent UAT (메인넷 인터랙티브 검증)

**Goal:** AI 에이전트가 마크다운 시나리오를 읽고 사용자와 인터랙티브하게 메인넷에서 실제 기능을 검증하는 Agent UAT 체계를 구축한다.

**Target features:**
- Agent UAT 마크다운 시나리오 포맷 정의 + `/agent-uat` skill 파일
- Testnet 시나리오 7개 + Mainnet 기본 전송 시나리오 6개
- DeFi 프로토콜 시나리오 12개 (Jupiter, 0x, LI.FI, Across, Lido, Jito, Aave, Kamino, Pendle, Drift, Hyperliquid, DCent)
- 고급 기능 시나리오 (Smart Account, WalletConnect, x402, 수신 TX, 가스 조건부) + Admin UI 검증 시나리오 13개
- CI 시나리오 등록 강제 + Admin UI 라우트/메뉴 일관성 검증
...
- ◆ v31.8 Agent UAT (메인넷 인터랙티브 검증) — in progress
...
**누적:** 91 milestones (v0.1-v31.6), 356 phases, ~804 plans, ~2,461 requirements, 49 설계 문서(24-79 + m29-00), 10 objective 문서, ~259,644 LOC TS, ~7,200+ 테스트
...
---
*최종 업데이트: 2026-03-09 after v31.7 milestone*
