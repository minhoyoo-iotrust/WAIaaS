...
- ~190,000 LOC TypeScript (ESM-only, Node.js 22, Admin UI ~26,000 LOC, Push Relay ~1,782 LOC)
...
**누적:** 63 milestones (v0.1-v28.5), 259 phases, 556 plans, 1,557 requirements, 40 설계 문서(24-76), 8 objective 문서, ~190,000 LOC TS, ~5,000 테스트
