...
- ◆ **v30.2 운영 기능 확장 구현** — m30-02, 6 OPS 기능 구현 (Dry-Run/Audit/Backup/Webhook/Stats/AutoStop)
...
<!-- Current Milestone: v30.2 운영 기능 확장 구현 -->

- [ ] Transaction Dry-Run — POST /v1/transactions/simulate, 부수 효과 없는 시뮬레이션 (OPS-01)
- [ ] Audit Log Query API — GET /v1/audit-logs, cursor pagination, 20개 이벤트 타입 (OPS-02)
- [ ] Encrypted Backup & Restore — AES-256-GCM 아카이브, REST API + CLI 4 커맨드 (OPS-03)
- [ ] Webhook Outbound — HMAC-SHA256 서명, 재시도 큐, CRUD API 4개 (OPS-04)
- [ ] Admin Stats API — 7 카테고리 JSON 통계, 1분 TTL 캐시 (OPS-05)
- [ ] AutoStop Plugin Architecture — IAutoStopRule 추출, RuleRegistry, Admin API (OPS-06)
