...
- ~223,044 LOC TypeScript (ESM-only, Node.js 22, Admin UI ~26,000 LOC, Push Relay ~1,782 LOC)
- ~5,595 테스트 (core + adapter-solana + adapter-evm + daemon + CLI + SDK + wallet-sdk + MCP + admin + push-relay + actions)
...
**누적:** 73 milestones (v0.1-v29.6), 290 phases, ~648 plans, ~1,837 requirements, 48 설계 문서(24-76 + m29-00), 8 objective 문서, ~225,248 LOC TS, ~5,595 테스트
...
---
*최종 업데이트: 2026-03-01 after v29.6 milestone*
