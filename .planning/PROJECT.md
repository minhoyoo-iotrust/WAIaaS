...
#### Current Milestone: v29.0 고급 DeFi 프로토콜 설계

**Goal:** 상태를 가진 DeFi 포지션(담보/차입, 수익률 거래, 레버리지 트레이딩)을 관리하기 위한 3개 프레임워크와 공통 인프라를 설계 수준에서 정의

**Target features:**
- ILendingProvider 프레임워크 설계 (Aave V3, Kamino, Morpho)
- IYieldProvider 프레임워크 설계 (Pendle)
- IPerpProvider 프레임워크 설계 (Drift)
- PositionTracker 공통 인프라 설계 (통합 포지션 테이블, 동기화, API, Admin UI)
- 모니터링 통합 설계 (IDeFiMonitor, HealthFactor/Maturity/Margin 3개 모니터)
- Intent/서명 패턴 설계 (CoW Protocol, SignableOrder, EIP-712)
...
---
*최종 업데이트: 2026-02-26 after v29.0 milestone start*
