...
서명 앱 선택을 name 기반 암묵적 매칭에서 wallet_type 기반 명시적 선택으로 전환. DB v61 partial unique index로 wallet_type당 signing primary 유일성 보장, WalletAppService exclusive signing 토글 트랜잭션, SignRequestBuilder를 wallet_type + signing_enabled=1 단일 쿼리로 전환, Admin UI 서명 컨트롤을 wallet_type 그룹별 라디오 버튼으로 변경, signing_sdk.preferred_wallet deprecated. 3 phases, 4 plans, 15 requirements, 18 commits, 15 files, +1,367/-462 lines.
...
- ✅ v33.0 Desktop App 아키텍처 재설계 — shipped 2026-03-31 (3 phases, 6 plans, 18 requirements)
- ✅ v33.2 Tauri Desktop App — shipped 2026-04-01 (5 phases, 12 plans, 37 requirements)
- ✅ v33.3 Desktop App 배포 채널 확장 — shipped 2026-04-01 (3 phases, 3 plans, 16 requirements)
- ✅ v33.4 서명 앱 명시적 선택 — shipped 2026-04-02 (3 phases, 4 plans, 15 requirements)
...
---
*최종 업데이트: 2026-04-03 after v33.6 milestone start*
