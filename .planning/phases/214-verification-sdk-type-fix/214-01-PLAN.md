...
must_haves:
  truths:
    ...
    - "All 4 success criteria from ROADMAP.md are verified with file:line references"
  artifacts:
  ...
  key_links:
    - from: "212-VERIFICATION.md"
      ...
      via: "4 requirement entries + 4 observable truths"
...
- status: passed
- score: 4/4 success criteria verified (from ROADMAP.md Phase 212 success criteria)
- re_verification: false
- gaps: []
- human_verification: []

**Observable Truths (4, from ROADMAP.md Phase 212 success criteria):**
...
- Frontmatter has `status: passed` and `score: 4/4`
- All 4 observable truths from ROADMAP.md success criteria are VERIFIED
