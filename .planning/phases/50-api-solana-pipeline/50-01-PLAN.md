...
<objective>
Create the Hono 4.x API server framework with 6 middleware (requestId, hostGuard, killSwitchGuard, requestLogger, errorHandler, zodValidator) and GET /health endpoint.
...
Output: `createApp()` factory, 6 middleware modules, /health route, tests.
</objective>
