...
Output: internal/design/76-incoming-transaction-monitoring.md 내 §2.1, §2.6, §2.7, §3.7, §5.1, §5.2, §7.6, §8.9 섹션이 수정됨
</objective>
...
- IncomingTransaction 타입(§1.2)에는 is_suspicious를 추가하지 않는다 (DB 전용 필드 — Research의 Open Question 2번 결정 따름).
  ...
  <verify>
internal/design/76-incoming-transaction-monitoring.md에서 다음을 확인:
