# Requirements Archive: v1.4.4 Admin Settings + MCP 5-type + Skill Files
...
- [x] **ADMIN-01**: 알림 설정 섹션 (Telegram/Discord/Ntfy credential + 활성화 + 테스트)
- [x] **ADMIN-02**: RPC 엔드포인트 섹션 (Solana 3 + EVM 13 + 테스트 연결 버튼)
- [x] **ADMIN-03**: 보안 파라미터 섹션 (session_ttl, rate_limit, policy_defaults)
- [x] **ADMIN-04**: WalletConnect 섹션 (project_id 입력 + 획득 방법 안내)
- [x] **ADMIN-05**: 데몬 log_level 설정
...
- [x] **SKILL-01**: quickstart.skill.md (월렛 생성 → 세션 → 잔액 → 첫 전송)
- [x] **SKILL-02**: wallet.skill.md (월렛 CRUD + 자산 조회 + 멀티체인)
- [x] **SKILL-03**: transactions.skill.md (5-type 전송 + 상태 조회)
- [x] **SKILL-04**: policies.skill.md (10 PolicyType CRUD)
- [x] **SKILL-05**: admin.skill.md (관리자 API — 상태/알림/설정)
...
| ADMIN-01 | Phase 102 | Done |
| ADMIN-02 | Phase 102 | Done |
| ADMIN-03 | Phase 102 | Done |
| ADMIN-04 | Phase 102 | Done |
| ADMIN-05 | Phase 102 | Done |
| MCP-01 | Phase 103 | Done |
| MCP-02 | Phase 103 | Done |
| MCP-03 | Phase 103 | Done |
| MCP-04 | Phase 103 | Done |
| SKILL-01 | Phase 104 | Done |
| SKILL-02 | Phase 104 | Done |
| SKILL-03 | Phase 104 | Done |
| SKILL-04 | Phase 104 | Done |
| SKILL-05 | Phase 104 | Done |
