# Requirements Archive: v31.0 NFT 지원
...
- [x] **ADUI-01**: Wallet detail page NFT tab with grid/list view
- [x] **ADUI-02**: NFT image thumbnails with CSP `img-src` update (IPFS/Arweave gateways)
- [x] **ADUI-03**: NFT detail modal showing metadata and attributes
- [x] **ADUI-04**: Indexer settings UI in System Settings

### MCP + SDK

- [x] **MCPSK-01**: MCP tools: `list_nfts`, `get_nft_metadata`, `transfer_nft`
- [x] **MCPSK-02**: SDK methods: `listNfts()`, `getNftMetadata()`, `transferNft()`
- [x] **MCPSK-03**: connect-info NFT summary (graceful omission when indexer not configured)
...
| MCPSK-01 | Phase 337 | Complete |
| MCPSK-02 | Phase 337 | Complete |
| MCPSK-03 | Phase 337 | Complete |
| ADUI-01 | Phase 337 | Complete |
| ADUI-02 | Phase 337 | Complete |
| ADUI-03 | Phase 337 | Complete |
| ADUI-04 | Phase 337 | Complete |
