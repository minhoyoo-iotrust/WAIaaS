...
Plans:
- [x] 449-01: Core 타입 변경 (ResponseChannelSchema, APPROVAL_METHODS, sign-request-builder)
- [x] 449-02: DB v60 마이그레이션 (wallet_apps.push_relay_url, sign_topic/notify_topic 정리)
- [x] 449-03: Push Relay 서버 ntfy 제거 + 자체 응답 저장소 전환
